...
const about = () => {
  return (
    <div className="flex flex-col  items-center h-screen">
      ...
      <meta name="description" content="ინფორმაცია ჩვენს შესახებ" />
      <meta
        name="keywords"
        content="ჩვენს შესახებ, ინფორმაცია შეკვეთის შესახებ. როგორ შევუკვეთო, ხელნაკეთი, ხის ხელნაკეთი, ხის ხელნაკეთი ნივთები, საჩუქარი, სასაჩუქრე, ხონჩა, xoncha, handmade, ხონჩა საჩუქარი, ხონჩა სასაჩუქრე, ჩარხი, საჩარხი დაზგა, გამოჩარხული ნივთები"
      />
